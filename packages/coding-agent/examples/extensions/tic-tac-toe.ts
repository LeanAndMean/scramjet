...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@leanandmean/coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@leanandmean/tui";
