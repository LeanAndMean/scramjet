...
Example extensions for the coding agent.

## Usage

```bash
# Load an extension with --extension flag
scramjet --extension examples/extensions/permission-gate.ts

# Or copy to extensions directory for auto-discovery
cp permission-gate.ts ~/.scramjet/agent/extensions/
```
...
| Extension | Description |
|-----------|-------------|
| `mac-system-theme.ts` | Syncs scramjet theme with macOS dark/light mode |
...
| `custom-provider-gitlab-duo/` | GitLab Duo provider using `@leanandmean/ai`'s built-in Anthropic/OpenAI streaming via proxy |
