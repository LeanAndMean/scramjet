 ...
 * working indicator shown while scramjet is streaming a response.
 *
 * Usage:
 *   scramjet --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore scramjet's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@leanandmean/coding-agent";
...
function describeMode(mode: WorkingIndicatorMode): string {
	switch (mode) {
		...
		case "default":
			return "scramjet default spinner";
	}
}
