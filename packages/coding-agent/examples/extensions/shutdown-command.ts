 ...
 * Demonstrates how extensions can use ctx.shutdown() to exit scramjet cleanly.
 */
...
export default function (pi: ExtensionAPI) {
	// Register a /quit command that cleanly exits scramjet
	pi.registerCommand("quit", {
		description: "Exit scramjet cleanly",
	...
	pi.registerTool({
		...
		description: "Complete a task and exit scramjet",
	...
	pi.registerTool({
		...
		description: "Deploy the application and exit scramjet",
		parameters: Type.Object({
