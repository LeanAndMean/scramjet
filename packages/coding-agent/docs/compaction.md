...
For TypeScript definitions in your project, inspect `node_modules/@leanandmean/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@leanandmean/pi-coding-agent";
